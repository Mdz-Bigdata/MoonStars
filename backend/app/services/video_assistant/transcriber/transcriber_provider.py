...
from app.services.video_assistant.transcriber.groq import GroqTranscriber
from app.services.video_assistant.transcriber.whisper import WhisperTranscriber
from app.services.video_assistant.transcriber.bcut import BcutTranscriber
from app.services.video_assistant.transcriber.kuaishou import KuaishouTranscriber
...
if platform.system() == "Darwin" and os.environ.get("TRANSCRIBER_TYPE") == "mlx-whisper":
    try:
        from app.services.video_assistant.transcriber.mlx_whisper_transcriber import MLXWhisperTranscriber
